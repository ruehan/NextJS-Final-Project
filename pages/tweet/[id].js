    ...
    <>
      <div className="w-full h-screen grid grid-cols-3">
        ...
        <div className="border-r-2 border-gray overflow-scroll scrollbar-hide border-b-2">
          <div className="">
            <h1 className="font-bold text-2xl p-4 sticky top-0 z-10 bg-white/30 backdrop-blur-sm h-24 font-Mynerve">Tweet</h1>
          ...
          {replies.reply.map((reply) => (
            <div className="flex flex-col border-t-2 border-b-2 border-gray-100">
                ...
                <div className="pl-8 pr-8 pb-8 font-Mugung text-2xl font-bold">{reply.content}</div>
            </div>
          ))}
        </div>
